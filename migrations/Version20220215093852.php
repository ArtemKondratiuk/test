 ...
 */
final class Version20220215093852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE content text VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD content VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP text, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
